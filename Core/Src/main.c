...
/* Private macro -------------------------------------------------------------*/
/* USER CODE BEGIN PM */
extern unsigned char fondo_mario[];
...
int main(void) {
	...
	LCD_Bitmap(0, 0, 320, 240, fondo_mario);
	LCD_Sprite(posicion_x_mario, posicion_y_mario, 20, 19, mario_corriendo, 4, animacion_mario_corriendo, 0,
			0);
	...
	while (1) {
		...
		if (derecha_mario == 1) {
			...
			LCD_Sprite(posicion_x_mario, posicion_y_mario, 20, 19,
					mario_corriendo, 4, animacion_mario_corriendo, 0, 0);
		}
		...
		if (derecha_mario == 0) {
			...
			animacion_mario_corriendo = (posicion_x_mario / 5) % 4;
			LCD_Sprite(posicion_x_mario, posicion_y_mario, 20, 19,
					mario_corriendo, 4, animacion_mario_corriendo, 1, 0);
		}
		if (salta_mario) {
			...
			if (posicion_y_mario <= 195 && velocidad_y_mario !=0) {
				LCD_Sprite(posicion_x_mario, posicion_y_mario, 20, 19,
						mario_saltando, 1, 0, 0, 0);
			} else {
				LCD_Sprite(posicion_x_mario, posicion_y_mario, 20, 19, mario_corriendo, 4, 1,
						0, 0);
			}
